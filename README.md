...
- **Data Migration & Real-world Data Import:**
  - เพิ่มสคริปต์นำเข้าข้อมูลจากระบบเดิม (`json_ห้องพัก.json`) เข้าสู่ฐานข้อมูล PostgreSQL อัตโนมัติ (รองรับข้อมูลห้อง, ผู้เช่า, และประวัติมิเตอร์น้ำ-ไฟย้อนหลัง)
  - ล้างข้อมูลจำลอง (Seed Data) เก่าทั้งหมด เพื่อรองรับข้อมูลชุดใหม่ที่มีความแม่นยำสูง
- **Admin Dashboard & Room Analytics:**
  - สร้างหน้าจอ **Room Detail Dashboard** สำหรับแอดมิน ให้สามารถคลิกดูรายละเอียดเชิงลึกของแต่ละห้องได้
  - แสดงข้อมูลผู้เช่าปัจจุบัน, ประวัติแจ้งซ่อม, บิลค้างชำระ ของห้องนั้นๆ ได้ในหน้าเดียว
  - เพิ่มระบบแสดง **"ค่าไฟ-ค่าน้ำแบบเรียลไทม์ (Live IoT Flow)"** ในรูปแบบ Animated SVG สำหรับแอดมิน
  - เพิ่มกราฟและตารางแสดง **"ประวัติการใช้หน่วยน้ำ-ไฟ (Monthly Usage)"** โดยคำนวณจากส่วนต่างของเลขมิเตอร์อัตโนมัติ ทำให้กราฟสมจริงและดูง่าย
- **Data Privacy:**
  - ผู้เช่าคนใหม่ จะเห็นประวัติกราฟมิเตอร์เฉพาะ **"หลังจากวันที่ตนเองเริ่มทำสัญญาเช่า (Lease Start Date)"** เท่านั้น เพื่อความเป็นส่วนตัว (ซ่อนประวัติของคนเช่าเก่า) แต่แอดมินสามารถดูข้อมูลได้ทั้งหมด
- **UI/UX Improvements:**
