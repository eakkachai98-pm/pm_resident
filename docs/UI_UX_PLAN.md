...
- [ ] **ระบบแจ้งเตือนกิจกรรมในแอป (In-App Notification Center & Activity Log):**
  - สร้างโมเดล `Notification` ใน Database เพื่อเก็บประวัติกิจกรรมทั้งหมดในระบบ (Who did what when)
  - เพิ่มไอคอนกระดิ่ง 🔔 (Bell Icon) บน Header ของทุกสิทธิ์ผู้ใช้งาน
  - แจ้งเตือนแบบแบ่งแยกตามสิทธิ์ (Role-based Alert) เช่น แอดมินจะเห็นแจ้งเตือนเมื่อลูกบ้านอัปโหลดสลิป, ลูกบ้านจะเห็นแจ้งเตือนเมื่อช่างรับงานซ่อม
